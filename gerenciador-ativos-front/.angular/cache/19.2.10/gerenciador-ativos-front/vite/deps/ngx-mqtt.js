    ...
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        ...
        6: [function(require2, module3, exports3) {
                      ...
                      if (alias) {
                        ...
                        if (topic.length !== 0) {
                          if (client.options.autoAssignTopicAlias) {
                            ...
                            if (alias) {
                              packet.topic = "";
                              packet.properties = __spreadProps(__spreadValues({}, packet.properties), {
                                topicAlias: alias
                              });
          ...
          "./default-message-id-provider": 12,
          "./store": 13,
          "./topic-alias-recv": 14,
          "./topic-alias-send": 15,
          "./validations": 16,
        ...
        73: [function(require2, module3, exports3) {
          ...
          function ReInterval(callback, interval, args) {
            ...
            this.reschedule = function(interval2) {
              if (!interval2) interval2 = self2._interval;
              if (self2._interval) clearInterval(self2._interval);
...
var MqttModule = class _MqttModule {
  ...
  static {
    this.ɵfac = function MqttModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _MqttModule)();
    };
  }
  static {
...
var MqttService = class _MqttService {
  ...
  static {
    this.ɵfac = function MqttService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _MqttService)(ɵɵinject(MqttServiceConfig), ɵɵinject(MqttClientService));
    };
  }
  static {
